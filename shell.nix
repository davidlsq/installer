let
  nixpkgs = builtins.fetchTarball {
    name = "nixos-23.05-5d017a8822e0";
    url = "https://github.com/NixOS/nixpkgs/archive/5d017a8822e0.tar.gz";
    sha256 = "0q2ayp60pyzd6kcj3dcn28nzbpsh44mxl08y8mcmm0gxnqd54xl8";
  };
  pkgs = import nixpkgs { };
