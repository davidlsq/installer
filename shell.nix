let
  nixpkgs = builtins.fetchTarball {
    name = "nixos-23.05-841889913dfd";
    url = "https://github.com/NixOS/nixpkgs/archive/841889913dfd.tar.gz";
    sha256 = "1v6b5v7vpprbj9i7vy7hnx1q660dq1a6xx2094r6341a2sb18r8m";
  };
  pkgs = import nixpkgs { };
