...
cp -r "$DIRECTORY/host_vars" "$OUTPUT_INSTALL/host_vars"
rm -rf "$_/$HOST" && cp -rL "$DIRECTORY/host_vars/$HOST" "$_"
cp -r "$DIRECTORY/files" "$OUTPUT_INSTALL/files"
rm -rf "$_/$HOST" && cp -rL "$DIRECTORY/files/$HOST" "$_"
